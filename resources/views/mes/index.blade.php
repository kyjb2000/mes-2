        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a class="J_menuItem" href="{{url('search_work_order')}}"><i class="fa fa-columns"></i> <span class="nav-label">工单查询</span></a>
                    </li>
                    <li>
                        <a class="J_menuItem" href="{{url('new_work_order')}}"><i class="fa fa-columns"></i> <span class="nav-label">新建工单</span></a>
                    </li>
                    <li>
                        <a class="J_menuItem" href="{{url('create_run_card')}}"><i class="fa fa-columns"></i> <span class="nav-label">Run Card开立</span></a>
                    </li>
                    <li>
                        <a class="J_menuItem" href="{{url('dismantle_run_card')}}"><i class="fa fa-columns"></i> <span class="nav-label">Run Card拆批</span></a>
                    </li>
                    <li>
                        <a class="J_menuItem" href="{{url('run_card_on_line')}}"><i class="fa fa-columns"></i> <span class="nav-label">Run Card下线</span></a>
                    </li>
                    <li>
                        <a class="J_menuItem" href="{{url('run_card_close')}}"><i class="fa fa-columns"></i> <span class="nav-label">Run Card入库</span></a>
                    </li>
                    <li>
                        <a class="J_menuItem" href="{{url('station_wip')}}"><i class="fa fa-columns"></i> <span class="nav-label">站区WIP表</span></a>
                    </li>
                    <li>
                        <a href="#">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li><a class="J_menuItem" href="search_work_order.blade.php">DataTables</a>
                            </li>
